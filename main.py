...
def attack(char_name: str, char_class: str) -> str:
    """Вывод функции = строка и параметр тоже строка."""
...
def defence(char_name: str, char_class: str) -> str:
    """В функции у парметров значения строка и вывод функции строка."""
    if char_class == 'warrior':
    ...
    return ('блок, блок и ещё блок!')


def special(char_name: str, char_class: str) -> str:
    """Функция и параметр при выводе будут строкой."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """В функции у парметров значения строка и вывод самой функции строка."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Результат вывода функции будет строкой."""
    approve_choice: str = ''
    char_class: str = ''
